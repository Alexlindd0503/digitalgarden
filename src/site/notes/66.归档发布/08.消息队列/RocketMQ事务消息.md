---
{"dg-publish":true,"permalink":"/66.归档发布/08.消息队列/RocketMQ事务消息/","dg-note-properties":{"时间":"2026-03-15"}}
---
...
事务消息依赖于消息持久化机制，详见 [[66.归档发布/08.消息队列/RocketMQ消息持久化\|RocketMQ消息持久化]]。如果你在面试中被问到分布式事务，可以重点准备 [[66.归档发布/08.消息队列/RocketMQ面试题\|RocketMQ面试题]] 中的事务消息相关问题。
...
实际使用中注意避免这些坑：详见 [[66.归档发布/04.并发/分布式/分布式系统常见陷阱清单\|分布式系统常见陷阱清单]] 中的消息队列相关章节。
