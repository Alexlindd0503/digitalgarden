---
{"dg-publish":true,"permalink":"/01.专项学习/JavaVirtualMachine/4.JVM调优/"}
---
...
最常见的问题是内存分配不合理，对象频繁晋升老年代，导致频繁 Full GC，系统每隔几分钟卡顿几秒。分代模型和参数含义见 [[01.专项学习/JavaVirtualMachine/2.JVM内存划分\|2.JVM内存划分]]，GC 触发条件见 [[01.专项学习/JavaVirtualMachine/3.垃圾回收\|3.垃圾回收]]，G1 参数调优见 [[01.专项学习/JavaVirtualMachine/6.G1垃圾回收器\|6.G1垃圾回收器]]。
...
![jstat显示说明.png](/img/user/attachment/jstat%E6%98%BE%E7%A4%BA%E8%AF%B4%E6%98%8E.png)
...
问题：每次 Young GC 后有 20~30MB 对象进入老年代，频繁触发 Full GC。

原因：Survivor 只有 10MB，装不下存活对象，直接溢出到老年代。
...
![调优后GC详情.png](/img/user/attachment/%E8%B0%83%E4%BC%98%E5%90%8EGC%E8%AF%A6%E6%83%85.png)
