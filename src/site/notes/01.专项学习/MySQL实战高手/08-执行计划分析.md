...
![Explain详情|400](https://raw.githubusercontent.com/Alexlindd0503/obsidian-img/main/Explain详情.png)
## 2. 各字段详解
...
比如 `varchar(20) utf8`，key_len = 20×3 + 2 = 62（utf 8 每字符 3 字节，varchar 额外 2 字节记录长度）。
...
- 索引失效 → 检查[[01.专项学习/MySQL实战高手/07-索引设计与调优#5. 常见索引失效场景\|07-索引设计与调优#5. 常见索引失效场景]]
- 排序没用索引 → 把排序字段加入联合索引
