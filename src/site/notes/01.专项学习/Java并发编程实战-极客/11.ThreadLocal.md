---
{"dg-publish":true,"permalink":"/01.专项学习/Java并发编程实战-极客/11.ThreadLocal/","dg-note-properties":{}}
---
...
- 底层是数组，用**[[66.归档发布/00-0其他/Hash冲突的解决方案#2.1 线性探查\|线性探测法]]**解决 Hash 冲突
- Hash 值通过魔数 `0x61c88647` 累加，分布均匀
![threadLocal线性探测法](https://raw.githubusercontent.com/Alexlindd0503/obsidian-img/main/threadLocal线性探测法.png)
JDK 8 之前是 ThreadLocal 维护一个 Map，key 是 Thread，线程数多的时候线程销毁后 key 变悬空引用，内存利用率低。
![threadLocal jdk8 before](https://raw.githubusercontent.com/Alexlindd0503/obsidian-img/main/threadLocal_jdk8_before.png)

JDK 8 改为 Thread 持有 Map，线程销毁时整个 Map 随之回收。
![threadlocal jdk8 after](https://raw.githubusercontent.com/Alexlindd0503/obsidian-img/main/threadlocal_jdk8_after.png)
## 3. 为什么会内存泄漏？


`ThreadLocalMap` 的 Entry 结构：

![ThreadLocal内存泄露](https://raw.githubusercontent.com/Alexlindd0503/obsidian-img/main/ThreadLocal内存泄露.png)
