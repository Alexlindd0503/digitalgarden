---
{"dg-publish":true,"permalink":"/01.专项学习/Java并发编程实战-极客学习/05.原子性解决方案-互斥锁/"}
---
...
Lock 系列的底层实现见 [[66.归档发布/04.并发/AQS抽象队列同步器原理\|AQS抽象队列同步器原理]]，Lock 相比 synchronized 的优势（可中断、超时、公平锁）见 [[01.专项学习/Java并发编程实战-极客学习/09.并发工具类#Lock 与 Condition\|09.并发工具类#Lock 与 Condition]]。
