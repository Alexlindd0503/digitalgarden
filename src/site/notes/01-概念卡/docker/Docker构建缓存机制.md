---
{"dg-publish":true,"permalink":"/01-概念卡/docker/Docker构建缓存机制/","tags":["docker","构建缓存","性能优化","buildkit","概念卡"]}
---
...
## 12. 相关概念
- [[01-概念卡/docker/Docker镜像构建原理\|Docker镜像构建原理]] - 分层存储
- [[03-方法卡/docker/Dockerfile最佳实践\|Dockerfile最佳实践]] - 构建优化
- [[03-方法卡/docker/Docker多阶段构建详解\|Docker多阶段构建详解]] - 高级技巧
